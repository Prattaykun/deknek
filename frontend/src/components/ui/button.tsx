  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all disabled:pointer-events-none disabled:opacity-50 outline-none focus-visible:ring-2 focus-visible:ring-offset-2 focus-visible:ring-offset-background",
  {
    variants: {
      variant: {
        ...
        secondary: "bg-white/85 text-[var(--slate-900)] hover:bg-white focus-visible:ring-[var(--brand-500)]",
        outline: "border border-[var(--slate-300)] bg-white/70 hover:bg-white text-[var(--slate-900)] focus-visible:ring-[var(--brand-500)]",
        ghost: "hover:bg-[var(--slate-100)] text-[var(--slate-900)] focus-visible:ring-[var(--brand-500)]",
      },
      size: {
